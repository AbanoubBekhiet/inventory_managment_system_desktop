...
<body>
    ...
    <div class="content" style="padding-bottom:200px;position:relative;" >
            ...
            <div style="font-size:19px;display:flex;justify-content:space-evenly;width:300px;">
                <div style="display:flex;">
                    ...
                    <div style="display:flex;flex-direction:column;">
                        <span>&nbsp&nbsp 01200277612</span>
                        <span> &nbsp&nbsp 01287573679</span>
                    </div>
                </div>
            </div>
            <hr style="height:2px;background-color:black">
            <div class="customer_data" style="position:relative;">
                <div class="date" style="position:relative;right:10px;top:10px;">التاريخ : {{$products[0]->created_at}}</div>
        ...
        <div class="total" style="margin:40px;width:fit-content;font-size:20px;margin-right:100px;">إجمالي الفاتورة : {{$products[0]->total_price}}</div>
